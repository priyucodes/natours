...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJpeWFuc2h1YmhhbmRhcmkiLCJhIjoiY2tydnJ6Y2o2MDlwMjJucWozZXlnenZtciJ9.EHleuQ4aTwC5ohTKOQHJLA';
  ...
  var bounds = new mapboxgl.LngLatBounds(); // Bounds Obj is basically the area that will be displayed on the map.
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              // location.reload();
              location.assign('/');
            } //  true -> reload from the server not from the browser cache
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Signed Up!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Reset token sent successfully!');
            }
...
var stripe = Stripe('pk_test_51JM8jZSJq82n5S79pIga39FtfnJuf7I8Q2NCLhT4RFUI0ySF3tDgOOzp1mseyGgJTIR3Kdv65Mw3u4zvd86ebR0u00j9nEEesk');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); // Creating multipart form-data
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            token = document.querySelector('.btn--new-pass').dataset.token;
            _context3.next = 6;
            return (0, _forgotPassword.resetPassword)(password, passwordConfirm, token);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "62071" + '/');
